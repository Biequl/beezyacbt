...
<section class="content-header">
    <h1><center>
        Selamat Datang
		<br>
        <small>ADMINISTRATOR <?php if(!empty($site_name)){ echo $site_name; } ?></small>
    </center></h1>
</section>
<body>
<!-- Main content -->
<section class="content">
    <div class="content-header"><center>
		<img src="<?php echo base_url(); ?>public/images/logo.png" class = "img-circle" alt="User Image" height="100" width="100"/>
		<br>
		<br>
    </center></div>
        ...
        <div class="col-md-6">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">PROKTOR CBT</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
